...
class _ShopWowAppState extends State<ShopWowApp> {
  ...
  void initState() {
    super.initState();
    _deviceTypeNotifier.init(); //usefull For Manish //! TODO: support
    ...
    Intl.defaultLocale = PlatformDispatcher.instance.locale.toLanguageTag(); //usefull For Manish //! TODO: support
    _appLoader = _loadApp();
  }
  ...
  void _onLoginStateChanged(bool newIsLoggedIn) {
    scheduleMicrotask(() { //usefull For Manish //! TODO: support
      ...
      child: FutureBuilder<Backend>(
        ...
        builder: (BuildContext context, AsyncSnapshot<Backend> snapshot) {
          if (snapshot.connectionState != ConnectionState.done) {
            return Theme( //usefull For Manish //! TODO: support
